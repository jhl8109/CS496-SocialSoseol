    ...
    return (
        <Grid style={{ 'padding' : '10px', 'marginTop':'10px'}}>
            <Paper elevation={4} style = {paperStyle}>
                ...
                <TextField multiline value = {textValue} rows={35}  variant='standard' style = {textStyle} label='본문' placeholder="글쓰기" InputProps={{ classes: { input: classes.input2 }}} inputProps={textProps} onChange={e=>textChange(e)} fullWidth required/>   
